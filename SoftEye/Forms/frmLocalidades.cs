...
namespace SoftEye.Forms
{
    public partial class frmLocalidades : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            formPacientes.LimpiarLocalidad(loc);
        ...
        private void dataGridLocalidades_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            if(dataGridLocalidades.Rows.GetRowCount(DataGridViewElementStates.Selected) > 0)
            {
                txtLocalidad.Text = dataGridLocalidades.SelectedRows[0].Cells[1].Value.ToString();
